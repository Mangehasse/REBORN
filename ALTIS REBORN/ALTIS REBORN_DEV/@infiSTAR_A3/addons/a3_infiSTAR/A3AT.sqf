...
VERSION_DATE_IS = '28-Sep-2016 21-05-38#3458';
infiSTAR_MAIN_CODE = "
				...
				case 83: {
					if('Arsenal' call ADMINLEVELACCESS)then
					{
						...
						if(_id > -1)then
						{
							...
							_id = -1;
							systemChat '<infiSTAR.de> Arsenal Action removed from player';
						}
						else
						{
							_id = player addAction ['Arsenal',{['Open',true] call BIS_fnc_arsenal;}];
							systemChat '<infiSTAR.de> Arsenal Action added to player';
						};
