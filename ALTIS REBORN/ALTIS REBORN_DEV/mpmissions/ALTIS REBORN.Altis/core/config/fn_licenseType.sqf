...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "military": {_var = "license_cop_military"}; //military License cost
			...
			case "donator2": {_var = "license_civ_donator3"};
			case "donator3": {_var = "license_civ_donator5"};
			...
			case "zinc": {_var = "license_civ_zinc"};
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_cop_military": {_var = "military"}; //military License cost
			...
			case "license_civ_rebel": {_var = "rebel1"}; //Rebel License1
			case "license_civ_rebel2": {_var = "rebel2"}; //Rebel License2
			case "license_civ_rebel3": {_var = "rebel3"}; //Rebel License3
			case "license_civ_truck":{_var = "truck"}; //Truck License
			case "license_civ_smugglarlasse":{_var = "smugglarlasse"}; //Smugglarlasse License
			...
			case "license_civ_donator5": {_var = "donator5"};
			...
			case "license_civ_zinc": {_var = "zinc"};
			default {_var = ""};
		};
	};
};
